...
public class Calculadora {
	...
	public static void main(String[] args) {
		 ...
		 * empregou-se o primeiro "for" para esses três compartilhamentos secundários (i<3)
		 * e o segundo "for" para o número de pessoas da primeira camada (j<pessoasQueCompartilharamPrimario).
		 * Com isso, calculou-se o número de visualizações após os compartilhamentos primários:
		 */
